...
/*   Updated: 2023/08/31 17:55:28 by ekulichk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (map_params->textures.no != NULL)
		free(map_params->textures.no);
	if (map_params->textures.so != NULL)
		free(map_params->textures.so);
	if (map_params->textures.we != NULL)
		free(map_params->textures.we);
	if (map_params->textures.ea != NULL)
