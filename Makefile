...
#    Updated: 2023/07/19 10:54:33 by vlenard          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = main.c raycaster.c init_data.c utils.c parser.c map_to_coordinate.c minimap.c help_functions.c key_bindings.c
OBJ = $(SRC:.c=.o)
LIBFT = libft/libft.a
